...
export interface ApiCaseStudyCaseStudy extends Schema.CollectionType {
  ...
  attributes: {
    ...
    completeddate: Attribute.String;
...
export interface ApiPortfolioPortfolio extends Schema.CollectionType {
  ...
  attributes: {
    ...
    categories: Attribute.Relation<
      ...
      'api::category.category'
    >;
    display: Attribute.Media;
    fullvideo: Attribute.Media;
    snippetvideo: Attribute.Media;
    Showcase: Attribute.Boolean & Attribute.Required;
    role: Attribute.String;
    client: Attribute.String;
    sortorder: Attribute.Integer;
    createdAt: Attribute.DateTime;
